	...
	public static void main(String[] args) {
		...
		Consumer<String> con = new Consumer<String>() {
			...
			public void accept(String t) {
				// t 는 Consumer 객체를 사용하는 ArrayList 객체에 저장된 item 이 전달된다
				System.out.println(t);
			}
		};
		/*
		 *  .forEach() 메소드를 호출하면서 전달한 Consumer 객체의 accept() 메소드가
		 *  배열에 저장된 item 의 개수만큼 호출되고
		...
		/*
		 * 매개변수의 개수가 1개일때는 매개변수를 둘러싸는 ( ) 는 생략 가능
		 * 매개변수의 이름은 마음대로 정할 수 있다 (배열에 저장된 item 이라는 의미에서 item 으로 정함) 
		 * 함수안에서 실행할 code 가 1줄 이거나 또는 리턴할 값만 명시할 때는 { } 도 생략 가능
		 */
