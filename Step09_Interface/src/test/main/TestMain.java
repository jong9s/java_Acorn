...
public class TestMain { // 클래스의 범위를 나타내는 중괄호 "시작"
	...
	public static void doSomething() {
		// 어디에선가 클래스명에 . 찍어서 호출하는 메소드 TestMain.doSeomthing() 으로 호출할 수 있다.
	...
	public static void main(String[] args) {
		...
		// 객체 생성이나, 반복문, 메소드 호출 등을 여기서 연습을 하고 있는중
		TestMain t1 = new TestMain();
		t1.test();
		TestMain.doSomething();
	}
